...
# #Configuración para usar la CPU
# gpus = tf.config.list_physical_devices('GPU')
# if gpus:
#     # Hacer visible solo la GPU 1 (la tarjeta gráfica)
#     tf.config.set_visible_devices(gpus[0], 'GPU')
#     #Aceleración de la GPU :p
#     tf.config.experimental.set_memory_growth(gpus[0], False)

#Ruta dependiendo del sistema que se use
dirname = os.path.join(os.getcwd(),'C:/Users/Guido/Desktop/Devs/IA/guidod-IA/PROYECTO3CNN/cars dataset/ImagenesProcesadasCarros21x28')
...
y = np.array(labels)
#nota: las imagenes deben ser del mismo tamaño o la conversion producirá un error
...
INIT_LR = 0.01
epochs = 50 # Cantidad de iteraciones completas al conjunto de imágenes de entrenamiento
...
riesgo_model.save("automovilesV2.h5")
